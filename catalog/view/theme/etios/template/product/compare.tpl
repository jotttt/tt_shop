  ...
  <table class="compare-info">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/etios/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
    ...
    <tr>
      <td></td>
      <?php foreach ($products as $product) { ?>
      <td><button type="button" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button cart"><?php echo $button_cart; ?></td>
      <?php } ?>
    </tr>
    <tr>
      <td></td>
